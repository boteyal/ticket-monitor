...
def check_page():
    ...
    # בדיקת זמינות (נשאר רק בשביל הדוח הראשוני, לא קובע אם יש אזעקה)
    available_found = any(v.lower() in text.lower() for v in ["זמין", "פנוי", "הוסף לסל", "רכוש", "available", "בחר"])
...
def main():
    ...
    while True:
        ...
        try:
            ...
            # התיקון החשוב: אזעקה מופעלת רק אם נמצא גם התאריך וגם המחיר! 
            # מתעלמים ממילות זמינות כמו שציינת.
            tickets_found = result["date_found"] and result["price_found"]
